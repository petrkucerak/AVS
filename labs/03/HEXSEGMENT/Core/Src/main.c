...
static void MX_GPIO_Init(void)
{
   ...
   HAL_GPIO_WritePin(GPIOC, SR_Dat_Pin | SR_Ow_Pin | SR_Clk_Pin | LD3_Pin,
                     GPIO_PIN_RESET);

   /*Configure GPIO pins : SR_Dat_Pin SR_Ow_Pin SR_Clk_Pin */
   GPIO_InitStruct.Pin = SR_Dat_Pin | SR_Ow_Pin | SR_Clk_Pin;
